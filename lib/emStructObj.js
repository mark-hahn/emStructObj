...
(function() {
  ...
  exports.emStructObj = emStructObj = exports.emStructToObj = function(addr, name, arrayLen, logFormat) {
    var addrOrVal, idx, memberTypeDef, obj, results, type, typeInc, val, _l, _len3, _len4, _m, _n, _ref1;
    ...
    for (idx = _m = 0, _ref1 = arrayLen != null ? arrayLen : 1; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; idx = 0 <= _ref1 ? ++_m : --_m) {
      if (type) {
        addrOrVal = (typeof type.size === 'number' ? addr : getValue(addr, type.size));
      ...
      for (_n = 0, _len4 = struct.length; _n < _len4; _n++) {
        ...
        addrOrVal = (typeof memberTypeDef.size === 'number' ? addr : getValue(addr, memberTypeDef.size));
  ...
  exports.emObjToStruct = emObjToStruct = function(obj, addr, name) {
    var buf, bufSize, char, charSize, memberTypeDef, nestedMember, nestedStruct, newBufs, objArray, size, strAddr, type, typeInc, val, _l, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _p;
    ...
    for (_m = 0, _len4 = objArray.length; _m < _len4; _m++) {
      ...
      for (_n = 0, _len5 = struct.length; _n < _len5; _n++) {
        ...
        if (typeof val === 'string') {
          if (val.slice(0, 2).toLowerCase() === '0x' && format === 'hex') {
            val = parseInt(val.slice(2), 16);
          } else {
            ...
            newBufs.push(buf);
            strAddr = buf;
            for (_p = 0, _len7 = val.length; _p < _len7; _p++) {
              char = val[_p];
