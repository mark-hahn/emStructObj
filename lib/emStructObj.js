...
(function() {
  var addrInc, chkStruct, defLine, emStructObj, emdef, error, exports, haveError, isPointer, line, member, memberName, memberType, ptrMatch, struct, structName, structs, toHex, typeDef, word, wordIdx, words, _, _i, _j, _k, _len, _len1, _len2, _ref,
    __slice = [].slice,
  ...
  exports.emStructObj = emStructObj = exports.emStructToObj = function(addr, name, arrayLen) {
    ...
    for (idx = _m = 0, _ref1 = arrayLen != null ? arrayLen : 1; 0 <= _ref1 ? _m < _ref1 : _m > _ref1; idx = 0 <= _ref1 ? ++_m : --_m) {
      if (type) {
        ...
        results.push((type.format === 'hex' ? toHex(val) : val));
        addr += typeInc;
        continue;
      }
      obj = {};
  ...
  if (emdef.useShortcuts) {
    exports.emso = exports.ems2o = exports.emStructObj;
  }
